...
const CACHE_NAME = 'caliches-hub-2026.07.24.2306';
const CORE_ASSETS = [
  './index.html',
  './js/01_part01.js',
  './js/02_on_load.js',
  ...
  './js/19_shift_console.js',
  './js/20_site_inspection.js',
  './js/21_ops_meeting.js',
  './js/22_training_hub.js',
  './js/23_writeup_templates.js',
  './js/24_requests_rails.js',
  './js/25_payraise_deltas.js',
  './js/26_command_center.js',
  './js/27_marketing_v2.js',
  './js/39_admin_settings_tabs.js',
  './js/40_r08_fixes.js',
  './js/41_r09_consolidation.js',
  './js/42_r11_payment_state.js',
  './styles.css',
  './manifest.json',
  './caliches-cone.png',
  './icon-192.png',

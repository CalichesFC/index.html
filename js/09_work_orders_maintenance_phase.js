    ...
    var SC_FIELDS=[['sales','Sales ($)','From Axial: Dashboard &rarr; Net Sales'],['sales_ly','Sales last year ($)','From Axial: comparison tile (Same Date Last Year)'],['guest_count','Guest count'],['speed_seconds','Speed of service (sec)'],['labor_pct','Labor %','From Axial: Hourly Labor (% of Net)'],['inspection_score','Inspection score'],['training_pct','Training %'],['maintenance_open','Open maintenance'],['pick_n_take','Pick-N-Take'],['flips','Flips'],['complaints','Complaints']];

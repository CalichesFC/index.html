    ...
    function permDefault(role, fid){
        ...
        switch(fid){
            ...
            case 'team_growth': case 'training_hub': case 'requests_rails': case 'company_calendar': return true;

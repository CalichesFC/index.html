    ...
    var HUB_STATIC_REG = [
        ...
        { id:'livedash', label:'Live Dashboard', emoji:'&#128225;', section:'Dashboards', keywords:['live dashboard','dashboards','ncr','square','pulse','revenue','sales now'], roleCheck:function(){ return !!(window.DASH_ALLOW && window.DASH_ALLOW.live); }, go:function(){ openDashboards('live'); } },
        { id:'commandcenter', label:'Store Intelligence', emoji:'&#128202;', section:'Dashboards', keywords:['command center','store intelligence','dashboards','ops','at a glance','live ops','on the clock'], roleCheck:function(){ return !!(window.DASH_ALLOW && window.DASH_ALLOW.command); }, go:function(){ openDashboards('command'); } },
        ...
        { id:'managerdash', label:'Submissions & Activity', emoji:'&#128200;', section:'Dashboards', keywords:['manager dashboard','submissions','activity','dashboards','pop-ins','checklists','temp logs'], roleCheck:function(){ return !!(window.DASH_ALLOW && window.DASH_ALLOW.manager); }, go:function(){ openDashboards('manager'); } },
        ...
        { id:'maintdash', key:'maintdash', label:'Maintenance Leadership', emoji:'&#128295;', section:'Dashboards', keywords:['maintenance dashboard','dashboards','costs by store','vendor spend','leadership'], roleCheck:function(){ return !!(window.DASH_ALLOW && window.DASH_ALLOW.maint); }, go:function(){ openDashboards('maint'); } },
        ...
        { id:'scorecards', key:'scorecards2', label:'Store Scorecards', emoji:'&#127978;', section:'Dashboards', keywords:['scorecard','dashboards','metrics','kpi','sales vs ly','labor','speed','inspection'], roleCheck:function(){ return !!(window.DASH_ALLOW && window.DASH_ALLOW.scorecards); }, go:function(){ openDashboards('scorecards'); } },
        { id:'storehealth', label:'Store Health', emoji:'&#128737;&#65039;', section:'Dashboards', keywords:['store health','health score','0-100','green yellow red','the 4 number ones','what needs action'], roleCheck:function(){ return !!(window.DASH_ALLOW && window.DASH_ALLOW.health); }, go:function(){ openDashboards('health'); } },
